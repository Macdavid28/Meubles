...
export const Chairs = () => {
  ...
  const filtered = useMemo(() => {
    ...
    } else if (sortOption.value === "green") {
      sorted.filter((sort) => sort.color === "green");
    }
    return sorted;
  }, [sortOption]);
  ...
  return (
    <div className="py-4 bg-white">
      ...
      <h1 className="text-3xl px-4 text-black my-6 font-semibold ">Chairs</h1>
      ...
      <div className="flex justify-between">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 my-4 sm:mx-14  md:mx-0 lg:px-4">
          {filtered
