      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-[90rem] lg:px-8">
        <div className=" grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 xl:gap-x-8 ">
          {chair.products
            ...
            .slice(0, 8)
            .map((chair) => (
              <div className=" border-white border-8 rounded-md shadow-md">
                <div
                  key={chair.id}
                  className="group relative border-8 border-white rounded-md p-4"
                >
                  <div>
                  ...
                  <span className="flex items-center gap-2">
                    <button className="bg-black text-center w-[85%] justify-center py-2 text-white my-2 rounded-md flex items-center gap-4">
                      Add to cart
